 ...
 * a "constructor", because some of those wrappers may get called by functions
 * in other libraries, before the constructor for this module gets called.
 * Thereafter, pointers received as arguments are untainted, and tainting
 * pointers generated by nested malloc calls is deactivated. Tainted pointers
 * should not be encountered while within wrappers, and calls to wrapped
