...
struct reg_entry reg_table[] = {
	...
	{ X86_REG_ESI, "esi", false, X86_REG_RSI, 4, 1, offsetof(ucontext_t, uc_mcontext.gregs[REG_RSI]), offsetof(struct patch_exec_context, general_purpose_registers[PATCH_X86_64_RSI]), -1, 0, {} },
